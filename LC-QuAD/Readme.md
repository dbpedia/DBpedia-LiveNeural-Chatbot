# **BENCHMARKING-using-[LCQuad-v1-dataset]()**
...
1. **Case 1 [spotlight_&_jac1.csv]()**
    ```
    precision score:  0.604106666666667
    recall score:  0.5939
    F-Measure score:  0.5989598544248503
    ```
    **Code - [spotlight_&_jac1.py]()** validation and comparison function imported can be found in **[convert.py]()**
...
2. **Case 2 [spotlight_&_jac2.csv]()**
    ```
    precision score:  0.5071223850468004
    recall score:  0.624875024995001
    F-Measure score:  0.5598742721857325
    ```
    **Code - [spotlight_&_jac2.py]()** validation and comparison function imported can be found in **[convert.py]()**
...
## **Observation from above implementations**
    ...
    4. Problem in template creation is because of mismatch of entity spelling or words or use of latin characters in given entity in dataset and the entity in question. template creation function is documented properly in convert.py
...
1. **Case 1 [only_jac_correct_temp1.csv]()**
    ```
    precision score:  0.6398153975246487
    recall score:  0.6396056219844766
    F-Measure score:  0.6397104925570269
    ```
    **Code - [only_jac_correct_temp1.py]()** validation and comparison function imported can be found in **[convert.py]()**
