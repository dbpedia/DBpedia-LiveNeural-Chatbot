# **This Branch "Benchmarks" is for our research work on entity linking.** 
## Which contains Different Benchmark and approaches of Different datasets.
## Benchmarks-

- [**LC-QUAD**](https://github.com/dbpedia/DBpedia-LiveNeural-Chatbot/tree/benchmarks/LC-QuAD)


# This also contains development code for Main branch.
